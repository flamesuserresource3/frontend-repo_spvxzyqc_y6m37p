...
export default function Blog() {
  return (
    <section id="blog" className="relative bg-gradient-to-b from-indigo-50/40 to-white py-20 dark:from-indigo-950/20 dark:to-black">
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white md:text-4xl">Recent Work & Insights</h2>
          <p className="mt-3 text-gray-600 dark:text-gray-300/80">A peek into methods, formatting, and productivity tips.</p>
        </div>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {posts.map((p, i) => (
            <motion.article
              ...
              className="group rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5"
            >
              ...
              <p className="mt-2 text-sm text-gray-600 dark:text-gray-300/80">{p.excerpt}</p>
              <a href="#contact" className="mt-4 inline-flex items-center gap-2 text-indigo-600 dark:text-indigo-400">
